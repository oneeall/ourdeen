...
class _MemorizingViewState extends State<MemorizingView> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _progressAnimation = Tween<double>(begin: 0, end: 1).animate(CurvedAnimation(parent: _controller, curve: Curves.elasticOut));

    _colorAnimation = ColorTween(begin: Colors.blue.withValues(alpha: 0.3), end: Colors.green.withValues(alpha: 0.8)).animate(_controller);
  }
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text('Memorization Journey', style: Theme.of(context).textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.bold)),
                  Container(
                      ...
                      children: [
                        ...
                        Builder(
                          builder: (context) {
                            ...
                            return Text('${_calculateTotalStreak(sessions)}', style: const TextStyle(fontWeight: FontWeight.bold));
                          },
                        ),
                      ],
                    ),
              ...
              Builder(
                builder: (context) {
                  final sessions = context.select<MemorizingViewModel, List<MemorizationSession>>((vm) => vm.sessions);
                  final isLoading = context.select<MemorizingViewModel, bool>((vm) => vm.isLoading);
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      color: (session.progress as double) == 1.0 ? Colors.green : Theme.of(context).colorScheme.primary,
            ...
            Row(
              children: [
                Icon(Icons.local_fire_department, color: (session.streak as int) > 0 ? Colors.orange : Colors.grey, size: 18),
                const SizedBox(width: 4),
                Text('${session.streak} day streak', style: Theme.of(context).textTheme.bodySmall),
                const Spacer(),
                Text(
